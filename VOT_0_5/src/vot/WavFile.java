...
public class WavFile{
	...
	public static WavFile newWavFile(File file, 
									int numChannels, 
									long numFrames, 
									int validBits, 
	...
	// numFramesToRead as Long
	// public int readFrames(int[] sampleBuffer, long numFramesToRead) throws IOException, WavFileException
	// {
		// return readFrames(sampleBuffer, 0, numFramesToRead);
	// }

	// public int readFrames(int[] sampleBuffer, int offset, long numFramesToRead) throws IOException, WavFileException
	// {
		// if (ioState != IOState.READING) throw new IOException("Cannot read from WavFile instance");
	...
	// numFramesToRead as Long
//	public int readFrames(double[] sampleBuffer, long numFramesToRead) throws IOException, WavFileException
//	{
//		return readFrames(sampleBuffer, 0, numFramesToRead);
//	}
//
//	public int readFrames(double[] sampleBuffer, int offset, long numFramesToRead) throws IOException, WavFileException
//	{
//		if (ioState != IOState.READING) throw new IOException("Cannot read from WavFile instance");
//
//		for (int f=0 ; f<numFramesToRead ; f++)
